...
async function loadModels() {
  ...
  note.textContent = data.configured
    ...
    : 'Подключение не настроено: администратору нужно заполнить токены или логин/пароль во вкладке /admin → Qwen Chat. Модели не имеют встроенных этических фильтров.';
